...
const handler = async (req, res) => {
  try{
    ...
    if(req.method === "PUT"){
      ...
      const response = await axios.put(`${SERVER_BASE_URL}/admin/forms/nominee`, req.body, {
        headers : {
    ...
    console.error("Server Error in api/forms/nominee ==> Error : ",error)
    return res.status(500).json({
      message : "Server Error Failed to update nominee details"
    })
  }
}
