...
const Sidebar = ({ mobileNavbar, setMobileNavbar }) => {
  ...
  return (
    <div
      className={
        mobileNavbar
          ? "py-5 bg-white border-r border-r-bright-gray h-[calc(100vh-68px)] block xl:flex lg:flex md:flex justify-between flex-col"
          : "py-5 bg-white border-r border-r-bright-gray h-[calc(100vh-68px)] hidden xl:flex lg:flex md:flex justify-between flex-col"
      }
    >
      <div>
        {topMenu.map((menu) => (
